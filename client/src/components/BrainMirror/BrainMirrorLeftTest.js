...
class BrainMirrorLeftTest extends Component {
	constructor(props) {
		super(props);
		this.state = {
			redirect: false,
	...
	render() {
		if(this.state.redirect) {
			return <Redirect to="/brainmirror/test/leftbrain" />
		}
...
export default connect(mapStateToProps, mapDispatchToProps)(BrainMirrorLeftTest);
