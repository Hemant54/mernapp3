...
class EachTest2 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render () {
        ...
        if(this.state.redirectToSuccess) {
            return (
                <Redirect to = {`/interviewsimulator/part3?id=${ this.state.testId }`} />
            );
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(EachTest2);
