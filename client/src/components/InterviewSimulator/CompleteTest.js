...
function CompleteTest (props) {
  ...
  var [url,setUrl] = useState((queryParams && queryParams[1].split("=")[1]) ? queryParams[1].split("=")[1] : `/api/downloadVideo/${props.userData.name}/${props.tests[0].testname}/${props.userData.test !== 0 ? props.userData.module - props.userData.test + 1 : props.userData.module}`);
...
export default connect(mapStateToProps, mapDispatchToProps)(CompleteTest);
