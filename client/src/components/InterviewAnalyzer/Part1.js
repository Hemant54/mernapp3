...
const steps = [
  ...
  },
  {
    ...
    content: () => (
      <Typography>
        Analysis of video is done here.
      </Typography>
    )
  }
]
...
class Part1 extends React.Component {
  ...
  closeTour = () => {
    this.setState({ isTourOpen: false, audioStatus: true, recordAudio: true });
  }
  ...
  render() {
    ...
    if (this.state.redirectToSuccess) {
      return <Redirect to={`/interviewanalyzer/part2?id=${this.state.testId}`} />;
    }
